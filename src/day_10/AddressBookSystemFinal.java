...
public class AddressBookSystemFinal
{
    ...
    {
        AddressBookSystemFinal.address_book.add(contact);
        for (ArrayList <String> i: AddressBookSystemFinal.address_book )
        {
            for (String j: i)
            {
    ...
    public void editExistingContact()
    {
        ...
        ArrayList<String> contact = enterContactDetails();
        AddressBookSystemFinal.address_book.set(index, contact);
    }
    ...
    public void deleteExistingContact()
    {
        ...
        String search_pers = sc.next();
        int index = searchExistingContact(search_pers);
        AddressBookSystemFinal.address_book.remove(index);
    }
    ...
    public static void main(String []args)
    {
        ...
        AddressBookSystemFinal edit  = new AddressBookSystemFinal();
        AddressBookSystemFinal del  = new AddressBookSystemFinal();
        AddressBookSystemFinal add  = new AddressBookSystemFinal();
        AddressBookSystemFinal multi  = new AddressBookSystemFinal();
        add.addPerson();
        multi.addMultiplePerson();
