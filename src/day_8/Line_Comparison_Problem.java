...
public class Line_Comparison_Problem
{
    ...
    static class CompareLength
    {
        public void checkEquality()
        {
            if (CalculateLength.length1.compareTo(CalculateLength.length2) > 0)
            {
                System.out.println("Line1 is greater than line2 in length");
            }
            else if (CalculateLength.length1.compareTo(CalculateLength.length2) < 0)
            {
